package com.leapmotion.leap
{
	...
	public class Frame
	{
		 ...
		 * of a null pointer exception. The invalid Frame mechanism makes it more
		 * convenient to track individual data across the frame history.
		 *
		 * Note: Currently hardcoded to always valid.
		 */
